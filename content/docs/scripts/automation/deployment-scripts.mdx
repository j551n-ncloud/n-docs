...
<Cards>
  <Card title="Monitoring Scripts" href="/docs/scripts" description="System monitoring and alerting automation" />
  <Card title="Backup Scripts" href="/docs/scripts" description="Automated backup and recovery solutions" />
  <Card title="Maintenance Scripts" href="/docs/scripts" description="Regular system maintenance automation" />
</Cards>